<%-- 
    Document   : index
    Created on : 22/05/2019, 04:26:17 PM
    Author     : Hp
--%>
        ...
        <div class="page-container">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="frmCategoria">
                                        <div class="row mt-3">
                                            <div class="form-group col-sm-9 col-12">
                                                <input type="text" id="txtCategoria" name="txtCategoria" class="form-control form-control-sm" placeholder="Nombre">
                                            </div>
                                            <div class="col-sm-3 col-12">
                                                <button type="submit" id="btnBuscarCat" class="btn btn-primary btn-xs mr-3"><i class="fa fa-search" aria-hidden="true"></i> Buscar</button>
                                                <button type="buton" id="btnAbrirNCat" class="btn btn-primary btn-xs"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-12">
                                            <select class="form-control form-control-sm" id="cbPagCategoria" name="cbPagCategoria">
            ...
            <footer>
                <div class="footer-area">
                    <p>© Copyright 2019 <a href="https://colorlib.com/wp/">Jkool</a>.</p>
                </div>
            </footer>
            <!-- footer area end-->
        </div>
